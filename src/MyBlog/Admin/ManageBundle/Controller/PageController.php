...
use MyBlog\CoreBundle\Entity\Page;
use MyBlog\CoreBundle\Form\PageType;
...
class PageController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MyBlogCoreBundle:Page')->findAll();
     ...
     * @Method("POST")
     * @Template("MyBlogAdminManageBundle:Page:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MyBlogCoreBundle:Page')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("MyBlogAdminManageBundle:Page:edit.html.twig")
     */
